...
The traditional continuous-time Markov chain diffusion limits rely purely on independent pointwise dynamics. The generative Moran Bridge models a fully interacting array of $N$ particles over a discrete topological grid, establishing set-to-set transformations globally to minimize continuous density mismatch inherently utilizing Permutation-Invariant metrics.
